...
describe('Searching restaurants', () => {
  ...
  describe('When query is not empty', () => {
    ...
    it('should show the name of the found restaurants', () => {
      ...
      expect(document.querySelectorAll('.restaurants-item__name')
          .item(0).textContent)
          .toEqual('Satu');
    });
    ...
    it('should show - when the restaurant returned does not contain a name', (done) => {
      document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
        const restaurantNames = document.querySelectorAll('.restaurants-item__name');
  ...
  describe('When no favorite restaurants could be found', () => {
    ...
    it('should not show any restaurant', (done) => {
      ...
      favoriteRestaurants.searchRestaurants.withArgs('restoran a')
          .and
          .returnValues([]);
